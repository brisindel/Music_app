...
public class MusicDetailAdapter extends ArrayAdapter<MusicDetail> {

    private static final String LOG_TAG = MusicDetailAdapter.class.getSimpleName();
     ...
     */
    public MusicDetailAdapter(Activity context, ArrayList<MusicDetail> musicDetails) {
